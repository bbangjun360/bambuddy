...
class PrintScheduler:
    ...
    async def check_queue(self):
        ...
        async with async_session() as db:
            ...
            # The farm fork is fail-closed: a missing setting keeps the physical
            # bed hold enabled. Schema and UI use the same True default; an
            # operator can still persist false to disable the upstream gate.
