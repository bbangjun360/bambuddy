...
class SwapmodStateMachineCycle(Base):
    """Durable SwapMod plate-change state owned by Bambuddy."""

    __tablename__ = "swapmod_state_machine_cycles"
    __table_args__ = (UniqueConstraint("cycle_key", name="uq_swapmod_state_machine_cycle_key"),)
    ...
    state: Mapped[str] = mapped_column(String(64), nullable=False, default="WAITING_FOR_PRINT_FINISH")
    ...
    retry_available: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    blocked_reason: Mapped[str | None] = mapped_column(Text, nullable=True)

    current_step: Mapped[str | None] = mapped_column(String(64), nullable=True)
    retry_step: Mapped[str | None] = mapped_column(String(64), nullable=True)
