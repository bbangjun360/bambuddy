...
class Settings(BaseSettings):
    ...
    # WP-110 structured sequence editor. Disabled by default; it writes only
    # inactive, pending-review candidate versions and cannot activate or send them.
    farm_swapmod_a1mini_sequence_editor_enabled: bool = False
