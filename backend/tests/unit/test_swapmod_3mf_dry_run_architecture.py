...
SERVICE = ROOT / "app/services/swapmod_3mf_dry_run.py"
ROUTE = ROOT / "app/api/routes/swapmod_3mf_dry_run.py"
SCHEMA = ROOT / "app/schemas/swapmod_3mf_dry_run.py"


class Swapmod3mfDryRunArchitectureTest(unittest.TestCase):
