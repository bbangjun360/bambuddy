...
class SwapmodSchedulerHandoffDiagnosticsApiTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_handoff_diagnostics_status_api_reports_safe_defaults(self) -> None:
        ...
        self.assertEqual(body["supported_gate_statuses"], ["allowed", "blocked"])
        self.assertEqual(
            body["supported_summary_boolean_fields"],
            [
        ...
        self.assertEqual(body["supported_summary_count_fields"], ["blocked_reason_count"])
        self.assertEqual(
            body["supported_summary_nullable_fields"],
            [
                "primary_blocker",
        ...
        self.assertEqual(
            body["supported_summary_collection_fields"],
            [
        ...
        self.assertEqual(
            body["supported_status_boolean_fields"],
            [
                "api_enabled",
                "read_only",
                "mutates_state",
        ...
        self.assertEqual(body["supported_status_string_fields"], ["mode", "required_permission"])
        self.assertEqual(
            body["supported_status_version_fields"],
            [
