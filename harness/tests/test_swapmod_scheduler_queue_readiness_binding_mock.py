...
class SwapmodSchedulerQueueReadinessBindingHarnessContractTest(unittest.TestCase):
    def test_makefile_exposes_swapmod_scheduler_queue_readiness_binding_target(self) -> None:
        makefile = (ROOT / "Makefile").read_text(encoding="utf-8")

        self.assertIn("harness-swapmod-scheduler-queue-readiness-binding:", makefile)
        self.assertIn(
            "test-swapmod-scheduler-queue-readiness-binding: "
    ...
    def test_mock_services_do_not_expose_scheduler_or_printer_control_routes(self) -> None:
        ...
        forbidden = [
            "/swapmod/v1/scheduler-queue-readiness-binding",
