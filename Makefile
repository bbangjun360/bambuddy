.PHONY: harness-config harness-up harness-up-slicer harness-up-observability harness-down harness-reset harness-health \
        ...
        harness-swapmod-canary-execution-gate harness-swapmod-a1mini-direct-canary harness-swapmod-bed-readiness harness-swapmod-next-print-gate harness-swapmod-scheduler-next-print-gate harness-swapmod-queue-readiness-binding harness-swapmod-scheduler-queue-readiness-binding harness-swapmod-scheduler-handoff-chain harness-swapmod-scheduler-consumed-handoff-retry harness-swapmod-scheduler-handoff-diagnostics harness-swapmod-scheduler-handoff-diagnostics-api harness-swapmod-scheduler-handoff-diagnostics-status harness-swapmod-scheduler-handoff-diagnostics-auth harness-swapmod-scheduler-handoff-diagnostics-explainability harness-swapmod-scheduler-handoff-diagnostics-status-contract harness-swapmod-scheduler-handoff-diagnostics-reason-catalog harness-swapmod-scheduler-handoff-diagnostics-blocker-details \
        ...
        test-swapmod-canary-execution-gate test-swapmod-a1mini-direct-canary test-swapmod-bed-readiness test-swapmod-next-print-gate test-swapmod-scheduler-next-print-gate test-swapmod-queue-readiness-binding test-swapmod-scheduler-queue-readiness-binding test-swapmod-scheduler-handoff-chain test-swapmod-scheduler-consumed-handoff-retry test-swapmod-scheduler-handoff-diagnostics test-swapmod-scheduler-handoff-diagnostics-api test-swapmod-scheduler-handoff-diagnostics-status test-swapmod-scheduler-handoff-diagnostics-auth test-swapmod-scheduler-handoff-diagnostics-explainability test-swapmod-scheduler-handoff-diagnostics-status-contract test-swapmod-scheduler-handoff-diagnostics-reason-catalog test-swapmod-scheduler-handoff-diagnostics-blocker-details \
