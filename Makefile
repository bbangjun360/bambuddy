...
harness-swapmod-scheduler-handoff-diagnostics-status:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_status_mock

harness-swapmod-scheduler-handoff-diagnostics-auth:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_auth_mock

harness-swapmod-scheduler-handoff-diagnostics-explainability:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_explainability_mock

harness-swapmod-scheduler-handoff-diagnostics-status-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_status_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-reason-catalog:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_reason_catalog_mock

harness-swapmod-scheduler-handoff-diagnostics-blocker-details:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_blocker_details_mock

harness-swapmod-scheduler-handoff-diagnostics-detail-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_detail_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-gate-status-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_gate_status_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-summary-boolean-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_summary_boolean_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-summary-count-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_summary_count_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-summary-nullable-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_summary_nullable_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-summary-collection-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_summary_collection_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-status-boolean-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_status_boolean_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-status-string-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_status_string_contract_mock

harness-swapmod-scheduler-handoff-diagnostics-status-version-contract:
	python3 -m unittest harness.tests.test_swapmod_scheduler_handoff_diagnostics_status_version_contract_mock

harness-release-readiness-acceptance:
	python3 -m unittest harness.tests.test_release_readiness_acceptance
...
test-swapmod-scheduler-handoff-diagnostics-status: harness-swapmod-scheduler-handoff-diagnostics-status
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-auth: harness-swapmod-scheduler-handoff-diagnostics-auth
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-auth-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-auth-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-explainability: harness-swapmod-scheduler-handoff-diagnostics-explainability
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-explainability-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-explainability-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.unit.services.test_swapmod_scheduler_handoff_diagnostics backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-status-contract: harness-swapmod-scheduler-handoff-diagnostics-status-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-reason-catalog: harness-swapmod-scheduler-handoff-diagnostics-reason-catalog
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-reason-catalog-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-reason-catalog-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.unit.services.test_swapmod_scheduler_handoff_diagnostics backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-blocker-details: harness-swapmod-scheduler-handoff-diagnostics-blocker-details
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-blocker-details-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-blocker-details-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.unit.services.test_swapmod_scheduler_handoff_diagnostics backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-detail-contract: harness-swapmod-scheduler-handoff-diagnostics-detail-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-detail-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-detail-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-gate-status-contract: harness-swapmod-scheduler-handoff-diagnostics-gate-status-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-gate-status-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-gate-status-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-summary-boolean-contract: harness-swapmod-scheduler-handoff-diagnostics-summary-boolean-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-summary-boolean-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-summary-boolean-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-summary-count-contract: harness-swapmod-scheduler-handoff-diagnostics-summary-count-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-summary-count-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-summary-count-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-summary-nullable-contract: harness-swapmod-scheduler-handoff-diagnostics-summary-nullable-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-summary-nullable-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-summary-nullable-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-summary-collection-contract: harness-swapmod-scheduler-handoff-diagnostics-summary-collection-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-summary-collection-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-summary-collection-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-status-boolean-contract: harness-swapmod-scheduler-handoff-diagnostics-status-boolean-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-boolean-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-boolean-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-status-string-contract: harness-swapmod-scheduler-handoff-diagnostics-status-string-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-string-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-string-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture

test-swapmod-scheduler-handoff-diagnostics-status-version-contract: harness-swapmod-scheduler-handoff-diagnostics-status-version-contract
	docker run --rm --network none -e LOG_TO_FILE=false -e DATA_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-version-contract-tests -e LOG_DIR=/tmp/bambuddy-swapmod-scheduler-handoff-diagnostics-status-version-contract-tests/logs -e PYTHONDONTWRITEBYTECODE=1 -v $(CURDIR):/workspace:ro -w /workspace --entrypoint python $(COMPOSE_PROJECT_NAME)-bambuddy:latest -m unittest backend.tests.integration.test_swapmod_scheduler_handoff_diagnostics_api backend.tests.unit.test_swapmod_scheduler_handoff_diagnostics_architecture
